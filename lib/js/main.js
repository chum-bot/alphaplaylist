...
function loadClient() {
    gapi.client.setApiKey("AIzaSyB1871EHPg-SjCi7XzAoJjry-NVtzT7Ans");
...
function playlistToSelect() {
    return gapi.client.youtube.playlists.list({
        ...
        .then(function (resp) {
            ...
            increaserOfSongs.addEventListener("click", function () { execute(arrayOfTheIds[0], response.result.nextPageToken) });
        })
}
function searchSong() {
...
function innerHTML(parent, html){
